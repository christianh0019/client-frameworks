        ...
        <div className={s.container}>
            <section className={s.paper}>
                ...
                <div className={s.body}>
                    ...
                    {/* What It Is */}
                    <div className="space-y-3">
                        <h4 className={s.sectionTitle}>What It Is:</h4>
                        <p className={s.p}>
                            This stage automatically captures new leads generated by a lead magnet. These contacts have not qualified themselves or provided any information other than their contact details in exchange for a guide or tool. They are automatically added to this pipeline stage upon submission.
                        </p>
                    </div>
                    ...
                    {/* Automations */}
                    <div className="space-y-3">
                        <h4 className={s.sectionTitle}>Automations:</h4>
                        <ul className={s.bulletList}>
                            <li><strong>You:</strong> Notified via text message for all new leads.</li>
                            <li><strong>The Lead:</strong> Receives an automated text message <strong>2-3 minutes</strong> after becoming a lead to appear human.</li>
                        </ul>
                        <p className={s.callout}>
                            "Hey I just saw you downloaded our [Asset Name]! Is this John?"
                        </p>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className={s.p}><strong>IMMEDIATELY</strong> call them after the automated text triggers.</p>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            {/* If No Answer */}
                            <div className="border border-gray-200 rounded-xl p-6">
                                <h3 className="font-bold text-gray-900 mb-4 text-lg">If No Answer</h3>
                                <p className="text-sm text-gray-500 mb-4 italic">Cadence: Call once every day for the next 4 days.</p>
                                <div className="space-y-4">
                                    <div className="text-sm text-gray-700">
                                        <p className="font-semibold mb-1">Step 1: Send a quick text</p>
                                        <div className="bg-gray-50 p-3 rounded text-gray-600 italic border border-gray-100">
                                            "Just tried to give you a ring John. Did you have a moment?"
                                        </div>
                                    </div>
                                    <div className="text-sm text-gray-700">
                                        <p className="font-semibold mb-1">Step 2: Leave a voicemail</p>
                                        <p className="text-xs text-gray-500">Keep it friendly, not annoying.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border border-gray-200 rounded-xl p-6">
                                ...
                                <button
                                    ...
                                    className="w-full mb-4 px-4 py-2 bg-indigo-50 text-indigo-700 font-medium rounded-lg hover:bg-indigo-100 transition-colors flex items-center justify-center"
                                >
                                    Open Qualification Script <ArrowRight size={16} className="ml-2" />
                                </button>

                                <div className="space-y-3 text-sm">
                                    <div className="p-3 bg-green-50 rounded border border-green-100">
                                        <span className="font-bold text-green-800 block">Qualified?</span>
                                        <span className="text-green-700">Move to "Qualified Lead" stage.</span>
                                    </div>
                                    <div className="p-3 bg-red-50 rounded border border-red-100">
                                        <span className="font-bold text-red-800 block">Disqualified?</span>
                                        <span className="text-red-700">Move to "Lost" & select Reason.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-3">
                        <h4 className={s.sectionTitle}>Special Circumstances:</h4>
                        <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                            <p className="text-gray-800 text-sm leading-relaxed">
                                <strong>Can I proceed to a Discovery Call immediately?</strong><br />
                                Yes, but it is <em>rare</em>. You may proceed with a discovery call during the qualification call <strong>ONLY IF</strong>:
                            </p>
                            <ul className="list-disc list-inside mt-2 text-sm text-gray-700 font-medium">
                                <li>All decision makers are present.</li>
                                <li>They are in a quiet, isolated environment.</li>
                                <li>Everyone has adequate time to talk.</li>
                            </ul>
                        </div>
                    </div>
